                    ...
                    <% if(t.getAvailableSeats() > 0) { %>
                        ...
                        <form action="book-ticket.jsp" method="get">
                            ...
                            <select name="trainClass">
                                <option value="GN">General (Cheap)</option>
                                <option value="SL">Sleeper (Medium)</option>
                                <option value="3AC">3rd AC (Comfort)</option>
                                <option value="2AC">2nd AC (Deluxe)</option>
                                <option value="1AC">1st AC (Luxury)</option>
                            </select>
